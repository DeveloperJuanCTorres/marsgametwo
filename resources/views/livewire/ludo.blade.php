...
<div x-data="data()" class="bg-gray-100 shadow border border-gray-300 overflow-hidden ">
    <div class="grid grid-cols-7 divide-x divide-gray-200">    
                            ...
                            <div class="col">
                                ...
                                <div class="first">
                                    ...
                                    <div class="col-one" id=9>
                                        <i class="props text-3xl las la-dove"></i></div>
                                ...
                                <div class="second">
                                    ...
                                    <div class="col-third" id=14 style="background-color: #F6F54D;">
                                        <i class="props text-4xl las la-flag-checkered"></i>
                                    </div>
                            ...
                            <div class="row">
                                <div class="four">
                                    ...
                                    <div class="row-one" id=1 style="background-color: #FF1700;">
                                        <i class="props text-4xl las la-flag-checkered" style="transform: rotate(-90deg);"></i>
                                    </div>
                                ...
                                <div class="six">
                                    ...
                                    <div class="row-third" id=48>
                                        <i class="props text-3xl las la-dove"></i>
                                    </div>
                            ...
                            <div class="col">
                                <div class="first">
                                    ...
                                    <div class="col-one" id=40 style="background-color: #019267;">
                                        <i class="props text-4xl las la-flag-checkered" style="transform: rotate(180deg);"></i>
                                    </div>
        ...
        <div class="col-span-8 xl:col-span-2 lg:col-span-2 sm:col-span-6 chat-desktop">
